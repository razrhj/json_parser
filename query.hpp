...
public:
  ...
  bool IsKey(const std::string &str) {
    return strings_types_[str]->type_ == "Key";
  }

  bool IsObject(const std::string &str) {
    return strings_types_[str]->type_ == "Object";
  }

  bool IsArray(const std::string &str) {
    return strings_types_[str]->type_ == "Array";
  }

  bool IsNumber(const std::string &str) {
    return strings_types_[str]->type_ == "Number";
  }

  bool IsBoolean(const std::string &str) {
    return strings_types_[str]->type_ == "Boolean";
  }

  bool IsNull(const std::string &str) {
    return strings_types_[str]->type_ == "Null";
  }

  bool IsString(const std::string &str) {
    return strings_types_[str]->type_ == "String";
  }
  ...
  std::vector<std::string> getBoolean(const std::string &str) {
    ...
    for (auto &parents : strings_types_[str]->parents_) {
      ...
      temp += strings_types_[str]->boolean_;
      ret.emplace_back(temp);
    }
    return ret;
  }
